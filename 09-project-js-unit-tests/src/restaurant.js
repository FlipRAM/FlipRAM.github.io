...
const createMenu = (menuPassado) => {
  const menu = {
    fetchMenu: () => menuPassado,
    consumption: [],
    order: (string) => {
    ...
    //     let cobranca = menu.consumption[i];
    //     let valueToAdd = menuPassado[cobranca];
...
// const dale = createMenu({ food: {}, drink: {} });
// console.log(dale.fetchMenu());
